      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        <div className="mb-8 animate-fade-in">
          ...
          <p className="text-lg text-muted-foreground/80 text-balance max-w-2xl mx-auto">
            Turning code into impact, one project at a time. Building exceptional web experiences that merge development
            expertise with construction technology innovation.
          </p>
        </div>
